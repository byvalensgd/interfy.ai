...
export const dssHeroFeatureChips: HeroFeatureChip[] = [
  ...
  { icon: "/icons/dss/alertas-inteligentes.svg" },
...
export const dssHowItWorksSteps: HowItWorksStep[] = [
  { number: "01", icon: "/icons/dss/step-upload.svg" },
  { number: "02", icon: "/icons/dss/step-user-add.svg" },
  { number: "03", icon: "/icons/dss/step-enviar.svg" },
  { number: "04", icon: "/icons/dss/step-assinar.svg" },
  { number: "05", icon: "/icons/dss/step-acompanhar.svg" },
  { number: "06", icon: "/icons/dss/step-concluido.svg" },
];
