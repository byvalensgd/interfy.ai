...
function EcosystemBadge({
  ...
  return (
    <div className="flex max-w-[38.095cqw] min-w-[28.571cqw] items-center gap-[2.381cqw] rounded-[2.381cqw]">
      ...
      <div className="flex min-w-0 flex-col gap-[1.19cqw] whitespace-nowrap">
