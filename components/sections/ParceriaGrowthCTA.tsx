        ...
        <Reveal className="relative flex w-full flex-col items-center gap-[30px] overflow-hidden rounded-2xl p-5 sm:px-[30px] sm:py-10">
          ...
          <div className="flex w-full flex-col items-start gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex w-full flex-wrap items-stretch gap-5 lg:w-auto lg:shrink-0">
              <Button href={href} variant="secondary" className="grow !whitespace-normal !text-base lg:grow-0" showArrow>
                {growthCta.primaryButton}
              </Button>
              <Link
                href={href}
                className="inline-flex min-h-[50px] grow shrink-0 items-center justify-center gap-2.5 rounded-lg border-[1.5px] border-branco bg-black/40 px-[15px] py-2.5 text-base leading-[1.2] font-bold !whitespace-normal !text-base text-branco transition-colors hover:bg-black/50 lg:grow-0"
              >
